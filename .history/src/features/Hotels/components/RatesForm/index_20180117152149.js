...
import Translation from 'core/languages/components/Transalation'
...
const Form = ({
  ...
  <WrapperForm
    ...
    submitButton={<Button type="submit" disabled={pristine || submitting || invalid} onClick={handleSubmit}>VALIIIIIIDER</Button>}
  >
